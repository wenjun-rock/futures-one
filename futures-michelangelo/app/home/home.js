...
.controller('micheHomeCtrl', ['$scope', '$http', 'CF',
  function($scope, $http, CF) {
    ...
    $.getJSON(CF.preurl + '/hedging/realtime/1', function(data) {
    ...
    $.getJSON(CF.preurl + '/hedging/realtime/2', function(data) {
    ...
    $.getJSON(CF.preurl + '/hedging/daily/1', function(data) {
    ...
    $.getJSON(CF.preurl + '/hedging/daily/2', function(data) {
